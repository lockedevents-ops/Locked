...
/**
 * Unified Notifications Page Component
 * --------------------------------------------------------------
 ...
 * 
 * This component is used by role-specific notification pages:
 * - /dashboards/user/notifications
 * - /dashboards/organizer/notifications
 * - /dashboards/venue-owner/notifications
 */
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        {/* Mobile Actions */}
        <div className="relative sm:hidden self-end" ref={actionsMenuRef}>
          <button
